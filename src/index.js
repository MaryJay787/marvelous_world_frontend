...
const myQuestions = [{
        ...
        answers: {
            captain_marvel: "https://a.wattpad.com/useravatar/-marvel.256.153129.jpg",
            the_hulk: "https://pngimg.com/uploads/hulk/hulk_PNG77.png",
            thor: "http://www.iconarchive.com/download/i60044/mattahan/ultrabuuf/Comics-Thor.ico"
        },
        correctAnswer: "captain_marvel"
    },
    {
        question: "What character has died the most?",
        answers: {
            captain_america: "http://mbch.guide/wp-content/uploads/GachaChasePrize_256x256_captain_america.png",
            jean_grey: "https://pm1.narvii.com/5705/7a1a455efb44d96e476d523c170a8114e8cca697_128.jpg",
            spider_man: "https://files.gamebanana.com/img/ico/sprays/spiderman_shadow.png"
        },
        correctAnswer: "jean_grey"
    }
]
...
function handleQuizBtn() {
    ...
    if (showQuiz) {
        ...
        function buildQuiz() {
            ...
            let question = []
            question.push(random_item(myQuestions))
                // for each question...
            question.forEach(
                (currentQuestion, questionNumber) => {
                    ...
                    for (char_name in currentQuestion.answers) {
                        answers.push(
                            `<label>
                              <input type="radio" name="question${questionNumber}" value="${char_name}">
                              ${char_name}:
                              <img src="${currentQuestion.answers[char_name]}">
                            </label>`
                        )
                    }
                    console.log(answers)
